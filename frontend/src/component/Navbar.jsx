  ...
  categories: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            { name: 'Levis', id:"levis" },
            { name: "Allen Solly", id:"allensolly" },
                    ...
                    <Tab.List className="-mb-px flex space-x-8 px-4">
                      {navigation.categories.map((category) => (
                        <Tab
                          ...
                          className={({ selected }) =>
                            classNames(
                              selected ? 'border-black text-black-600' : 'border-transparent text-black-900',
        ...
        <nav aria-label="Top" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              {/* Logo */}
              <div className="ml-4 flex lg:ml-0 mt-5 ">
                <a href="#">
                  <span className="sr-only">Your Company</span>
                  <img
                    className='object-contain h-30 w-40 relative bottom-4 '
                    src="/images/3.png"
                    alt=""
                  />
                </a>
